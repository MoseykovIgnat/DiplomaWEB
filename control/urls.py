...
urlpatterns = [
    ...
    path(PREFIX + 'get_information_about_condition_to_change_id/', views.get_information_about_condition_to_change_id, name='get_information_about_condition_to_change_id'),
